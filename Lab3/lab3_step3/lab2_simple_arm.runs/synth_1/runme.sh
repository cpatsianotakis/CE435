...
HD_PWD='/home/jesterhead1924/Documents/CE435-Embedded_Systems/Labs/vivado-projects/lab3_step3/lab2_simple_arm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_wrapper.tcl
