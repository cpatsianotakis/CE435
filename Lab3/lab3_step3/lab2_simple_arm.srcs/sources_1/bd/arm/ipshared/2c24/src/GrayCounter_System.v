...
module GrayCounter_System(clk, rst, button_state, leds, Display_C, Display_AA, Display_AB, Display_AC, Display_AD, Display_AE, Display_AF, Display_AG);
  parameter N = 8;
  input clk, rst, button_state;
  output [N-1:0] leds;
  output Display_C, Display_AA, Display_AB, Display_AC, Display_AD, Display_AE, Display_AF, Display_AG;
  wire pulse, button_posedge ;
