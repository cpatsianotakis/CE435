...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Display_AA [ create_bd_port -dir O Display_AA ]
  set Display_AB [ create_bd_port -dir O Display_AB ]
  set Display_AC [ create_bd_port -dir O Display_AC ]
  set Display_AD [ create_bd_port -dir O Display_AD ]
  set Display_AE [ create_bd_port -dir O Display_AE ]
  set Display_AF [ create_bd_port -dir O Display_AF ]
  set Display_AG [ create_bd_port -dir O Display_AG ]
  set Display_C [ create_bd_port -dir O Display_C ]
  ...
  # Create instance: gray_counter_ip, and set properties
  set gray_counter_ip [ create_bd_cell -type ip -vlnv user.org:user:gray_counter_ip:1.0 gray_counter_ip ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins gray_counter_ip/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net sw_8bit_GPIO [get_bd_intf_ports sw_8bits] [get_bd_intf_pins sw_8bit/GPIO]

  # Create port connections
  connect_bd_net -net gray_counter_ip_0_Display_AA [get_bd_ports Display_AA] [get_bd_pins gray_counter_ip/Display_AA]
  connect_bd_net -net gray_counter_ip_0_Display_AB [get_bd_ports Display_AB] [get_bd_pins gray_counter_ip/Display_AB]
  connect_bd_net -net gray_counter_ip_0_Display_AC [get_bd_ports Display_AC] [get_bd_pins gray_counter_ip/Display_AC]
  connect_bd_net -net gray_counter_ip_0_Display_AD [get_bd_ports Display_AD] [get_bd_pins gray_counter_ip/Display_AD]
  connect_bd_net -net gray_counter_ip_0_Display_AE [get_bd_ports Display_AE] [get_bd_pins gray_counter_ip/Display_AE]
  connect_bd_net -net gray_counter_ip_0_Display_AF [get_bd_ports Display_AF] [get_bd_pins gray_counter_ip/Display_AF]
  connect_bd_net -net gray_counter_ip_0_Display_AG [get_bd_ports Display_AG] [get_bd_pins gray_counter_ip/Display_AG]
  connect_bd_net -net gray_counter_ip_0_Display_C [get_bd_ports Display_C] [get_bd_pins gray_counter_ip/Display_C]
  connect_bd_net -net gray_counter_ip_0_leds [get_bd_ports leds] [get_bd_pins gray_counter_ip/leds]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins btns_5bit/s_axi_aclk] [get_bd_pins gray_counter_ip/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins sw_8bit/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins btns_5bit/s_axi_aresetn] [get_bd_pins gray_counter_ip/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sw_8bit/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gray_counter_ip/S_AXI/S_AXI_reg] SEG_gray_counter_ip_0_S_AXI_reg
