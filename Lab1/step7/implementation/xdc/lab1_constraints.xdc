...
set_property PACKAGE_PIN JC1_P [get_ports {Display_AA}]
set_property PACKAGE_PIN JC1_N [get_ports {Display_AB}]
set_property PACKAGE_PIN JC2_P [get_ports {Display_AC}]
set_property PACKAGE_PIN JC2_N [get_ports {Display_AD}]
set_property PACKAGE_PIN JD1_P [get_ports {Display_AE}]
set_property PACKAGE_PIN JD1_N [get_ports {Display_AF}]
set_property PACKAGE_PIN JD2_P [get_ports {Display_AG}]
set_property PACKAGE_PIN JD2_N [get_ports {Display_C}]
