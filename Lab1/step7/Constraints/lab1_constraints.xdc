...
#set_property PACKAGE_PIN AB6 [get_ports {Display_AA}]
#set_property PACKAGE_PIN AB7 [get_ports {Display_AB}]
#set_property PACKAGE_PIN AA4 [get_ports {Display_AC}]
#set_property PACKAGE_PIN Y4 [get_ports {Display_AD}]
#set_property PACKAGE_PIN W7 [get_ports {Display_AE}]
#set_property PACKAGE_PIN V7 [get_ports {Display_AF}]
#set_property PACKAGE_PIN V4 [get_ports {Display_AG}]
#set_property PACKAGE_PIN V5 [get_ports {Display_C}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AA}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AB}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AC}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AD}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AE}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AF}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_AG}]
set_property IOSTANDARD LVCMOS33 [get_ports {Display_C}]
