...
HD_PWD='/home/jesterhead1924/Documents/embedded_systems/Labs/vivado-projects/lab2_simple_arm/lab2_simple_arm.runs/arm_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_auto_pc_0.tcl
